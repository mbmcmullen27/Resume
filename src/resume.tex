...
\iconhref{Link}{5}{\textcolor{black}{Compiled with \LaTeX. View source:} https://github.com/mbmcmullen27/Resume}{https://github.com/mbmcmullen27/Resume}{blue} \\
...
\cvevent
	...
	{Busy doing all things DevOps and DevEx: Kubernetes administration, writing terraform, fixing helm charts, integrating with open source tools, github migrations, and automating myself into ambiguity}
	{\cvlist{
