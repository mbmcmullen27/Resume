...
\icontext{MapMarker}{12}{Milwaukee WI}{black}\\[6pt]
...
\cvskill{JavaScript} {10+ yrs} {0.95} \\[-2pt]

\cvskill{Regex *} {10+ yrs} {0.95} \\[-2pt]

\cvskill{C} {5+ yrs} {0.77} \\[-2pt]

\cvskill{Python} {5+ yrs} {0.75} \\[-2pt]

\cvskill{Java} {5+ yrs} {0.68} \\[-2pt]
...
\iconhref{Link}{5}{\small{\textcolor{black}{Compiled with \LaTeX. View source:} https://github.com/mbmcmullen27/Resume}}{https://github.com/mbmcmullen27/Resume}{blue} \\
...
My personal experience spans a variety of languages and frameworks focusing primarily in the Developer Portal and Experience space. I believe strongly in accessibility, interoperability, and compatibility. I'm a contributor on the Linux Foundations Certified Backstage Associate (CBA) exam. I advocate strongly for building a modern Developer experience, and enabeling developers to maximize their productivity. I want to work in an Engineering focused organization that understands the importance of modernizing the tech stack... \\

Therefore, Kubernetes at any scale, automation by default, cloud native architecture, open source software, and continuous improvement and development are  pillars I operate by. \\}
...
\cvevent
	...
	{Busy doing all things DevOps and DevEx: Kubernetes administration, terraform development, Developer Portal adoption and development, Backstage plugin implementations and template creation, fixing helm charts, creating helm charts, integrating with open source tools, github migrations, and automating myself into ambiguity}
	{\cvlist{
		\item Advise clients on DevOps best practices and recommend preferred tools
		\item Orchestrating major Github Enterprise migrations and building tools to make the experience easy
		...
		\item Internal Developer Portal (Backstage) development and administration
		\item Implement complex cloud native solutions in Azure and AWS
		\item Continuous learning and researching emergent technology
	...
	{\cvlist {
		...
		\item Owned, maintained, managed, and developed Boxboat's internal Backstage instance
...
\cvevent
	...
	{\cvlist {
		\item Migrated manually developed and deployed Azure Cloud resources and dotnet middle tier api, inherited from a vendor, to Terraform managed infrastructure as code while maintaining live production architecture.
