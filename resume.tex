...
\iconhref{Link}{5}{More than a resume! View source: https://github.com/mbmcmullen27/Resume}{https://github.com/mbmcmullen27/Resume}{black} \\
...
\cvevent
	{Aug 2021 - PRESENT}
	{DevOps Engineer, Boxboat an IBM company}
	{Consultation \& Implementation}
	{Busy doing all things DevOps, Kubernetes administration, writing terraform, fixing helm charts, integrating with open source tools, and automating myself into ambiguity}
	{\cvlist{
		...
		\item Github and Azure cloud administration
		\item Lead Github migrations and Actions development
	}}
	{\cvlist {
		\item \begin{flushleft}Built a helm based Github Actions Runner Controller for easy\end{flushleft}\linebreak Openshift integration: 
			https://github.com/boxboat-github-practice/github-arc-operator
		\item Owned, maintained, and managed Boxboat's internal Backstage instance
		\item Lead app development for client demos and automation testing: \linebreak
			https://github.com/boxboat-github-practice/simple-tracker-express-api 
