...
\cvevent
	...
	{Tier III Support}
	{On call support engineer for consumer directed healthcare administration application written in dotnet. Responsible for addressing defects and for -> make ticket go away.}
	{\cvlist{
